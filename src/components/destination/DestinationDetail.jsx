...
export const DestinationDetail = () => {
  ...
  return (
    <div className='p-8 md:max-w-[595px] lg:max-w-full mx-auto lg:mx-0 flex flex-col lg:flex-row lg:items-end space-y-6 md:space-y-14 lg:space-y-0'>
      ...
      <div className='lg:max-w-[445px] flex flex-col mx-auto lg:ml-auto space-y-6 md:space-y-14'>
        ...
        <div className='divide-y divide-solid divide-[#383B4B]'>
          <div className='pb-8 md:pb-12'>
            ...
            <p className='mt-3 text-center lg:text-left text-[#D0D6F9] text-sm md:text-lg lg:text-xl leading-6 md:leading-8 lg:leading-10 font-barlow tracking-wide'>{options[optionSelected].description}</p>
          </div>
