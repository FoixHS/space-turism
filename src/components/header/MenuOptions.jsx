...
export const MenuOptions = ({ onCloseMenu, className }) => {
  ...
  return (
    <div className={`z-100 fixed bottom-0 top-0 left-0 right-0 h-screen flex justify-end ${className}`}>
      <div className='flex-grow h-screen' onClick={() => closeMenu()} />
      <div className='w-[300px] backdrop-blur-2xl backdrop-brightness-100'>
